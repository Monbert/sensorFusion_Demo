 ...
 * \details For the given some data of sensor which 
 *    including number_of_sensor, value_of_each_sensor
 */
 ...
 * \details calculating the support degree of every two sensors and getting 
 *    the support degree matrix
 ...
 * \details generating an array of all values of 
 *    contribution rate of kth principal component
 * \param[in] *matrix - it is a pointer to a struct of matrix matrix
 * \param[in] n - it is a number of all sensors
 ...
 * \param[in] *z - it is a pointer to an array of 
 *    all values of integrated support degree score
 * \param[in] n - it is a number of all sensors
 ...
 * \param[in] *z_after - it is a pointer to an array new 
 *    integrated support degree score after disgarding wrong sensor data
 * \param[in] n - it is a number of all sensors
